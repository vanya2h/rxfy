...
The server tracks what each browser session was served and pushes updates over the WebSocket — see `live.serve` in server/api.ts and `live.hydration` in src/entry-server.tsx.
