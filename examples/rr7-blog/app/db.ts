...
export const db: {
  ...
  comments: [
    { id: "1" as CommentId, postId: "1" as PostId, name: "Bob Smith", body: "Great intro! The Atom primitive reminds me of Jotai atoms." },
    { id: "2" as CommentId, postId: "1" as PostId, name: "Carol Lee", body: "Does rxfy support derived state similar to Recoil selectors?" },
    { id: "3" as CommentId, postId: "2" as PostId, name: "Alice Doe", body: "The switchMap pattern you described is exactly what I needed for my project." },
    { id: "4" as CommentId, postId: "3" as PostId, name: "Carol Lee", body: "The params-as-Promise change in Next 15 caught me off guard at first." },
    { id: "5" as CommentId, postId: "3" as PostId, name: "Bob Smith", body: "How does HydrationStream differ from the old getServerSideProps approach?" },
    { id: "6" as CommentId, postId: "4" as PostId, name: "Alice Doe", body: "Zod's discriminated union support is seriously underrated." },
    { id: "7" as CommentId, postId: "4" as PostId, name: "Bob Smith", body: "Switched from io-ts to Zod six months ago and never looked back." },
    { id: "8" as CommentId, postId: "5" as PostId, name: "Carol Lee", body: "Does this streaming approach work with the Pages Router too?" },
    { id: "9" as CommentId, postId: "5" as PostId, name: "Alice Doe", body: "useServerInsertedHTML is the key — it hooks into Next's flush cycle." },
    { id: "10" as CommentId, postId: "1" as PostId, name: "Dave K", body: "Bookmarked. Looking forward to trying this in my own project." },
  ],
  nextCommentId: 11,
};
