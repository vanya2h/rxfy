...
**plain value fields** are not stored in any [Model](/core-concepts/model) store: they live in the
...
[SSR](/ssr) along with its entity ids — keep them JSON-serializable, the same constraint entities
have.
:::
