...
SSR also signs the channel **grants** a live client uses to receive pushes. See
...
Live apps use a different entry point for the same idea: [`live.hydration(registry)`](/framework/server/grants)
