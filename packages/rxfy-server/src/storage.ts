...
/**
 * A storage-neutral sync resource: the client-facing model + key extractor, plus an opaque
 ...
 * precise types live on the `Resource` generics and surface through `Sync`'s write methods.
 */
export type SyncStorage<TBinding = unknown> = {
