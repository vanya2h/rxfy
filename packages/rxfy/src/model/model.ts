...
// All three Zod generics are inferred so T comes from the Output position alone —
// z.ZodType<T> would put T in the Input position too and widen branded types away.
export function createModel<TOutput, TKey extends string, TDef extends z.ZodTypeDef = z.ZodTypeDef, TInput = TOutput>(
